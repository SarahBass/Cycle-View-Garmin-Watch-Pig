...
else if (today.sec%20==9 ||today.sec%20==10 || today.sec%20==11   ){  
dc.setColor(0x00F7EE, Graphics.COLOR_TRANSPARENT);   
...
else if (today.sec%20==12 ||today.sec%20==13 || today.sec%20==14 ){  
 dc.setColor(0x2AFA3F, Graphics.COLOR_TRANSPARENT);
dc.drawText(centerX, centerY*1.65, small, ".",Graphics.TEXT_JUSTIFY_CENTER);
dc.setColor(0x00F7EE, Graphics.COLOR_TRANSPARENT);
dc.drawText(centerX, centerY*1.7, wordFont, ("  "+sunriseHour + ":" + sunrise.min.format("%02u")+"AM"+"  "), Graphics.TEXT_JUSTIFY_RIGHT );    
dc.setColor(0xFFFF35, Graphics.COLOR_TRANSPARENT);  
dc.drawText(centerX, centerY*1.7, wordFont, ("  "+sunsetHour + ":" + sunset.min.format("%02u")+"PM"+"  "), Graphics.TEXT_JUSTIFY_LEFT ); }
else{
  dc.setColor(0x2AFA3F, Graphics.COLOR_TRANSPARENT);
dc.drawText(centerX, centerY*1.7, small, (" a "), Graphics.TEXT_JUSTIFY_RIGHT );
...
/*
dc.setColor(0x00F7EE, Graphics.COLOR_TRANSPARENT);
dc.drawText(centerX, centerY*1.6, smallFont, weather(cond),Graphics.TEXT_JUSTIFY_RIGHT);      
dc.drawText(centerX, centerY*1.7, wordFont, " "+TEMP+" "+FC, Graphics.TEXT_JUSTIFY_LEFT ); }
 */       
